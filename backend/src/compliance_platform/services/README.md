...
Modules: `document_parsers.py`, `chunking.py`, `ingestion_service.py` (Sprint 1); `assessment_service.py` (Sprint 2 — status state machine and evidence linking). Planned: `mapping_service.py` (Sprint 3-5), `scoring_service.py` (Sprint 3-4), `report_service.py` (Sprint 7).
