...
Modules: `health.py`, `ingestion.py` (Sprint 1), `assessments.py` (Sprint 2), `dependencies.py` (dependency-injection wiring, not a router — see its own docstring). Planned: `mappings.py` (Sprint 5), `reports.py` (Sprint 7).
