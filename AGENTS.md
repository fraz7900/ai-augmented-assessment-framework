...
```
cd backend && source .venv/bin/activate && pytest          # 669 tests as of Sprint 23 — run before finishing any backend change
...
cd frontend && npm run test    # vitest, 127 tests as of Sprint 23 — run before finishing any frontend change
