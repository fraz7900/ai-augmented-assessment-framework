...
```
cd backend && source .venv/bin/activate && pytest          # 747 tests as of Sprint 26 — run before finishing any backend change
...
cd frontend && npm run test    # vitest, 146 tests as of Sprint 26 — run before finishing any frontend change
