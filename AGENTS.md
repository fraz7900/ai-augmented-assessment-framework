...
```
cd backend && source .venv/bin/activate && pytest          # 658 tests as of Sprint 23 — run before finishing any backend change
...
cd frontend && npm run test    # vitest, 116 tests as of Sprint 23 — run before finishing any frontend change
